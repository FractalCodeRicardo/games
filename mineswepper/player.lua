...
function Player:new(name, x, y, baseSprite, opts)
    opts = opts or {}
    ...
    player.mode = opts.mode or keyboard_mode.new(player)
...
function Player:move(on_move, cells)
    self.mode:move(on_move, cells)
end
